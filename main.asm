...
;INCLUDE "data/pokemon/mew.asm" ;; Moved with other Pokemon's base stats
...
;INCLUDE "engine/overworld/turn_sprite.asm" ; removed
...
;INCLUDE "engine/pokemon/evos_moves.asm" ; Moved to Evo Moves Bank
