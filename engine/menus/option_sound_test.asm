...
SoundTestTextBlankTrack:
	db "                  @"
SoundTestTrackList:
	dw Title_Music_PalletTown, (MUSIC_PALLET_TOWN << 8) | Bank(Music_RBYPalletTown)
	dw Title_Music_Pokecenter, (MUSIC_POKECENTER << 8) | Bank(Music_Pokecenter)
	dw Title_Music_Gym, (MUSIC_GYM << 8) | Bank(Music_RBYGym)
	...
	dw Title_Music_IndigoPlateau, (MUSIC_INDIGO_PLATEAU << 8) | Bank(Music_RBYIndigoPlateau)
	...
	dw Title_Music_TitleScreen, (MUSIC_TITLE_SCREEN << 8) | Bank(Music_RBYTitleScreen)
	dw Title_Music_Credits, (MUSIC_CREDITS << 8) | Bank(Music_RBYCredits)
	dw Title_Music_HallOfFame, (MUSIC_HALL_OF_FAME << 8) | Bank(Music_RBYHallOfFame)
	...
	dw Title_Music_GameCorner, (MUSIC_GAME_CORNER << 8) | Bank(Music_RBYGameCorner)
	...
	dw Title_Music_GBPrinter, (MUSIC_GB_PRINTER << 8)
	dw Title_Music_UnusedSong, (MUSIC_UNUSED_SONG << 8)
