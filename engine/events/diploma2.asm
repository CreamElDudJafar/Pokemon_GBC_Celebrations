...
DisplayDiplomaPrint:
	...
	ld de, DiplomaTextPrint
	hlcoord 5, 2
	call PlaceString

	ld de, DiplomaPlayerPrint
	hlcoord 3, 4
	call PlaceString
	...
	ld de, DiplomaCongratsPrint
	hlcoord 2, 6
	call PlaceString

	ld de, DiplomaGameFreakPrint
	hlcoord 9, 16
	call PlaceString
...
DiplomaTextPrint:
	db CIRCLE_TILE_ID2, "Diploma", CIRCLE_TILE_ID2, "@"

DiplomaPlayerPrint:
	db "Player@"

DiplomaCongratsPrint:
	db   "Congrats! This"
